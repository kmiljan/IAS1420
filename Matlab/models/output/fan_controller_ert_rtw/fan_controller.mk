...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\fan_controller.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\fan_controller.exe
...
DEFINES_STANDARD = -DMODEL=fan_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\fan_controller_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\fan_controller_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : $(START_DIR)\fan_controller_ert_rtw\ert_main.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\fan_controller_ert_rtw\ert_main.cpp
